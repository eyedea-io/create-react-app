...
if ! deployment=$(curl -s \
                  ...
                  -d "{ \"ref\": \"${CIRCLE_SHA1}\", \"environment\": \"coverage\", \"description\": \"Coverage\", \"transient_environment\": true, \"auto_merge\": false, \"required_contexts\": []}" \
...
echo ${deployment_id} > coverage-deployment
